...
std::unique_ptr<hir::Expr> make_binary_expr(hir::BinaryOp::Op op,
...
TEST(MirLowerTest, LowersShortCircuitAnd) {
    ...
    auto and_expr = make_binary_expr(hir::BinaryOp::AND, std::move(lhs), std::move(rhs), bool_type);
...
TEST(MirLowerTest, LowersShortCircuitOr) {
    ...
    auto or_expr = make_binary_expr(hir::BinaryOp::OR, std::move(lhs), std::move(rhs), bool_type);
