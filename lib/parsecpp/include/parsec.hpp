...
Parser<R, Token> succeed(R value) {
  return Parser<R, Token>([value = std::move(value)](ParseContext<Token> &) mutable {
...
template <typename NewReturnType>
auto Parser<ReturnType, Token>::_andThen_impl(const Parser<NewReturnType, Token>& other) const {
    using PairReturnType = std::pair<ReturnType, NewReturnType>;
    return Parser<PairReturnType, Token>([p1 = *this, p2 = other](ParseContext<Token> &context) -> std::optional<PairReturnType> {
        auto originalPos = context.position;
...
auto Parser<ReturnType, Token>::orElse(const Parser<ReturnType, Token>& other) const {
  return Parser<ReturnType, Token>([p1 = *this, p2 = other](ParseContext<Token> &context) -> std::optional<ReturnType> {
    auto originalPos = context.position;
    auto res1 = p1.parse(context);
    if (res1) {
      return res1;
...
auto Parser<ReturnType, Token>::andThen(const Parser<NewReturnType, Token>& other) const {
    return _andThen_impl(other).map([](std::pair<ReturnType, NewReturnType>&& pair) {
...
auto Parser<ReturnType, Token>::keepLeft(const Parser<OtherReturnType, Token>& other) const {
    return _andThen_impl(other).map([](std::pair<ReturnType, OtherReturnType>&& pair) {
...
auto Parser<ReturnType, Token>::many() const {
  return Parser<std::vector<ReturnType>, Token>([p = *this](ParseContext<Token> &context) -> std::optional<std::vector<ReturnType>> {
...
auto Parser<ReturnType, Token>::optional() const {
  return Parser<std::optional<ReturnType>, Token>([p = *this](ParseContext<Token> &context) -> std::optional<std::optional<ReturnType>> {
    auto originalPos = context.position;
    auto res = p.parse(context);
    if (res) {
      return res;
...
template <typename ReturnType, typename Token>
template <typename SepType>
auto Parser<ReturnType, Token>::list1(const Parser<SepType, Token>& separator) const {
    return Parser<std::vector<ReturnType>, Token>([p = *this, sep = separator](ParseContext<Token> &context) -> std::optional<std::vector<ReturnType>> {
        auto originalPos = context.position;
...
template <typename ReturnType, typename Token>
template <typename SepType>
auto Parser<ReturnType, Token>::list(const Parser<SepType, Token>& separator) const {
    return this->list1(separator).orElse(succeed<std::vector<ReturnType>, Token>({}));
}
