...
- **[Lexer Component](../../src/lexer/README.md)** - Lexer implementation details
- **[Lexer Architecture](../../docs/component-overviews/lexer-overview.md)** - High-level lexer design

## See Also

- [Google Test Documentation](https://google.github.io/googletest/)
- [Lexer Implementation](../../src/lexer/lexer.hpp)
- [Token Stream Handling](../../src/lexer/stream.hpp)
- [Parser Tests](../parser/test_expr_parser.cpp.md) - Parser component tests