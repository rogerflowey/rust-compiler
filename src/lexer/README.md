...
- **Implementation Details**: [Lexer Header Reference](lexer.md)
- **Stream Positioning**: [Stream Documentation](stream.md)
- **Error Handling**: [Error Handling](../../docs/utils/error.md)
