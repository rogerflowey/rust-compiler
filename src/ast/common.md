...
2. **String Interning**: Identifier strings are not interned at this level to keep AST parser-agnostic
...
- **Parser Construction**: [../parser/README.md](../parser/README.md) - Type construction patterns
- **Symbol Resolution**: [../semantic/symbol/scope.md](../semantic/symbol/scope.md) - Usage in semantic analysis