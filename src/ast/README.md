...
- **Parser Integration**: [../parser/README.md](../parser/README.md) - AST construction patterns
- **HIR Conversion**: [../semantic/hir/hir.md](../semantic/hir/hir.md) - Transformation strategies
- **Visitor Implementation**: [./visitor/visitor_base.md](./visitor/visitor_base.md) - Traversal patterns
- **Pretty Printing**: [./pretty_print/pretty_print.md](./pretty_print/pretty_print.md) - AST printing utilities