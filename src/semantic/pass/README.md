...
The semantic analysis phase transforms AST through a series of passes, each establishing specific invariants for the next pass. This multi-pass refinement architecture enables clear separation of concerns and incremental compilation.
...
- [Component Cross-Reference](../../../docs/component-cross-reference.md): Component relationships
- [Agent Guide](../../../docs/agent-guide.md): Navigation and development protocols
- [Development Guide](../../../docs/development.md): Build processes and development practices
