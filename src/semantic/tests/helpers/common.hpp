...
protected:
    ...
    static std::unique_ptr<hir::Expr> createBinaryOp(std::unique_ptr<hir::Expr> lhs,
                                                     std::unique_ptr<hir::Expr> rhs,
                                                     hir::BinaryOperator op) {
    ...
    static std::unique_ptr<hir::Expr> createUnaryOp(std::unique_ptr<hir::Expr> operand, hir::UnaryOperator op) {
    ...
    // Convenience helpers for unary operators
    static hir::UnaryOperator makeUnaryNot(hir::UnaryNot::Kind kind = hir::UnaryNot::Kind::Unspecified) {
        return hir::UnaryNot{.kind = kind};
    }

    static hir::UnaryOperator makeUnaryNegate(hir::UnaryNegate::Kind kind = hir::UnaryNegate::Kind::Unspecified) {
        return hir::UnaryNegate{.kind = kind};
    }

    static hir::UnaryOperator makeReference(bool is_mutable = false) {
        return hir::Reference{.is_mutable = is_mutable};
    }

    static hir::UnaryOperator makeDereference() {
        return hir::Dereference{};
    }

    // Convenience helpers for binary operators
    static hir::BinaryOperator makeAdd(hir::Add::Kind kind = hir::Add::Kind::Unspecified) {
        return hir::Add{.kind = kind};
    }

    static hir::BinaryOperator makeMultiply(hir::Multiply::Kind kind = hir::Multiply::Kind::Unspecified) {
        return hir::Multiply{.kind = kind};
    }

    static hir::BinaryOperator makeEqual(hir::Equal::Kind kind = hir::Equal::Kind::Unspecified) {
        return hir::Equal{.kind = kind};
    }

    static hir::BinaryOperator makeLogicalAnd(hir::LogicalAnd::Kind kind = hir::LogicalAnd::Kind::Unspecified) {
        return hir::LogicalAnd{.kind = kind};
    }

    static hir::BinaryOperator makeBitAnd(hir::BitAnd::Kind kind = hir::BitAnd::Kind::Unspecified) {
        return hir::BitAnd{.kind = kind};
    }

    static hir::BinaryOperator makeShiftLeft(hir::ShiftLeft::Kind kind = hir::ShiftLeft::Kind::Unspecified) {
        return hir::ShiftLeft{.kind = kind};
    }
